    ...
    <section id='home' className='w-full py-20   pb-20 flex items-center  border-b-[1px] border-b-black'>
        <div className='w-10/12 flex flex-col gap-20'>
            ...
            <div className='flex gap-11 ps-8'>
                        ...
                        <a href='https://github.com/nagendrasomala'><FaGithub /></a>
                        </span>
                        <span className="bannerIcon">
                        <a href='https://leetcode.com/somala_nagendra/'><SiLeetcode/></a>
                        </span>
                        <span className="bannerIcon">
                        <a href='https://www.linkedin.com/in/somala-nagendra-babu-1464701b6/'><FaLinkedinIn /></a>
                        </span>
                </div>
            </div>
        </div>
